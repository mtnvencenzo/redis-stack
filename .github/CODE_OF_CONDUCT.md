# 🤝 Redis Stack Code of Conduct

## 🤝 Our Pledge

We as members, contributors, and leaders pledge to make participation in the Redis Stack project and our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community focused on providing excellent local Redis development environments.
...
- 🌍 Focusing on what is best not just for us as individuals, but for the overall community and Redis users
- 📚 Sharing knowledge and helping others learn Docker, Redis, and local development best practices
- 🔍 Contributing high-quality, well-documented, and reusable Redis configurations
...
**Cheers to a welcoming Redis development community! 🔴**
